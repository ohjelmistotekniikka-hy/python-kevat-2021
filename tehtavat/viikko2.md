...
Tehtävät on tarkoitus tehdä joko pajassa tai omatoimisesti. Tehtävien palautuksen deadline on ti 30.03. klo 23:59
...
```bash
wget https://raw.githubusercontent.com/ohjelmistotekniikka-hy/python-kevat-2021/master/misc/unicafe.zip
unzip unicafe.zip
rm unicafe.zip
```
